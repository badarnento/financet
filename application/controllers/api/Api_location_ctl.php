...
class Api_location_ctl extends REST_Controller {
    ...
    public function index_put()
    {
		...
		elseif($update === 0){
			...
			$message = [
						'status'  => false,
						'message' => 'Failed to update data location'
			        ];
...
/* End of file Api_location_ctl.php */
/* Location: ./application/controllers/api/Api_location_ctl.php */