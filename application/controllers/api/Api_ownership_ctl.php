...
class Api_ownership_ctl extends REST_Controller {
    ...
    public function index_post()
    {
		...
		if($insert > 0){
			...
			$message = [
						'status'  => false,
						'message' => 'Failed to add new ownership'
			        ];
    ...
    public function index_put()
    {
		...
		elseif($update === 0){
			...
			$message = [
						'status'  => false,
						'message' => 'Failed to update data ownership'
			        ];
...
/* End of file Api_ownership_ctl.php */
/* Location: ./application/controllers/api/Api_ownership_ctl.php */