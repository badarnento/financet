...
class Api_master_coa_ctl extends REST_Controller {
  ...
  $table3,
	...
	function __construct()
    {
		...
		$this->table = "MASTER_COA";
    $this->table2 = "MASTER_GROUP";
    $this->table3 = "MASTER_GROUP_RPT";
		$this->primary_key = "ID_MASTER_COA";
    $this->allowed_fields = array(
                'nature'       => 'NATURE',
                'description'    => 'DESCRIPTION',
                'id_group_rpt'       => 'ID_GROUP_RPT',
                // 'group_rpt_name'       => 'GROUP_RPT_NAME',
                'id_group'          => 'ID_GROUP'
    ...
    public function index_put()
    {
		...
		elseif($update === 0){
			...
			$message = [
						'status'  => false,
						'message' => 'Failed to update data Coa'
			        ];
...
/* End of file Api_master_coa_ctl.php */
/* Location: ./application/controllers/api/Api_master_coa_ctl.php */