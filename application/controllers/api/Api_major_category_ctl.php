...
class Api_major_category_ctl extends REST_Controller {
	...
	function __construct()
    {
		...
		$this->table = "MASTER_MAJOR_CATEGORY";
		$this->primary_key = "MAJOR_ID";
    ...
    public function index_post()
    {
		...
		if($insert > 0){
			...
			$message = [
						'id'      => $insert,
						'status'  => true,
						'message' => 'Major category has been added'
			        ];
			...
			$message = [
						'status'  => false,
						'message' => 'Failed to add new major category'
			        ];
    ...
    public function index_put()
    {
		...
		elseif($update === 0){
			...
			$message = [
						'status'  => false,
						'message' => 'Failed to update data major category'
			        ];
...
/* End of file Api_major_category_ctl.php */
/* Location: ./application/controllers/api/Api_major_category_ctl.php */