...
class Api_region_ctl extends REST_Controller {
    ...
    public function index_put()
    {
		...
		elseif($update === 0){
			...
			$message = [
						'status'  => false,
						'message' => 'Failed to update data region'
			        ];
...
/* End of file Api_region_ctl.php */
/* Location: ./application/controllers/api/Api_region_ctl.php */