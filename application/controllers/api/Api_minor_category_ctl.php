...
class Api_minor_category_ctl extends REST_Controller {
	...
	function __construct()
    {
		...
		$this->table = "MASTER_MINOR_CATEGORY";
		$this->primary_key = "MINOR_ID";
    ...
    public function index_post()
    {
		...
		if($insert > 0){
			...
			$message = [
						'id'      => $insert,
						'status'  => true,
						'message' => 'Minor category has been added'
			        ];
			...
			$message = [
						'status'  => false,
						'message' => 'Failed to add new minor category'
			        ];
    ...
    public function index_put()
    {
		...
		elseif($update === 0){
			...
			$message = [
						'status'  => false,
						'message' => 'Failed to update data minor category'
			        ];
...
/* End of file Api_minor_category_ctl.php */
/* Location: ./application/controllers/api/Api_minor_category_ctl.php */