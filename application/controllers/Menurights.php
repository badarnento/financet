...
class Menurights extends CI_Controller {
	...
	public function index()
	{
		...
		if($this->ion_auth->is_admin() == true || in_array("admin/menu-management", $this->session->userdata['menu_url']) ){

			$data['title']          	= 'Menu Rights';
			$data['module']         	= "datatable";
			$data['template_page']  	= "pages/menu";
			$data['activepage']    		= "administrator";
			$data['parent_singles'] 	= $this->menu->get_parent_single();
			$data['parents']        	= $this->menu->get_parent();
	...
	public function create_menu(){
		...
		if($this->ion_auth->is_admin() == true || in_array("admin/menu-management", $this->session->userdata['menu_url']) ){
			...
			$this->form_validation->set_rules('category', 'Kategori Menu', 'required|alpha');
