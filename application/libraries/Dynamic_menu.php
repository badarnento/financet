...
class Dynamic_menu {
    ...
    function build_menu($activepage="", $id = NULL)
    {
        ...
        if($id != NULL){
            ...
            $findMenuParent = $this->ci->db->query("SELECT PARENT_ID FROM MASTER_DYN_MENU ".$where." GROUP BY PARENT_ID");
        ...
        $query = $this->ci->db->query("SELECT * FROM MASTER_DYN_MENU ".$whereIn." ORDER BY SHOWORDER");
   ...
   function get_childs($id, $whereAnd = NULL)
    {
       ...
       $html_out  = "<ul class='nav nav-second-level'>";
        ...
        $query = $this->ci->db->query("SELECT * FROM MASTER_DYN_MENU WHERE PARENT_ID = ".$id." ".$whereAnd." AND SHOW_MENU = 1 ORDER BY SHOWORDER");
 ...
 function get_childs_third($id, $whereAnd = NULL)
    {
       ...
       $html_out  = "<ul class='nav nav-third-level'>";
        ...
        $query = $this->ci->db->query("SELECT * FROM MASTER_DYN_MENU WHERE  PARENT_ID = ".$id." ".$whereAnd." AND SHOW_MENU = 1 ORDER BY ID");
