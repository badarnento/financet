...
<title><?= $this->config->item('site_title') ?> | 404 PAGE NOT FOUND</title>
<!-- Bootstrap Core CSS -->
...
<section id="wrapper" class="error-page">
  <div class="error-box">
    <div class="error-body text-center">
      ...
      <footer class="footer text-center"> <?= date("Y") ?> &copy; <?= $this->config->item('site_title') ?> Created by <?= $this->config->item('site_author') ?> </footer>
  </div>
</section>
<!-- jQuery -->
