        ...
        <table width="100%" class="table display table-bordered table-striped table-responsive" id="table_data"> 
          <thead>
            <tr>
              ...
              <th class="text-center">TRIBE CODE</th>
              <th class="text-center">TRIBE DESC</th>
            ...
            <div class="modal-body"> 
              ...
              <div class="row">
                <div class="form-group">
                  <div class="col-lg-12">
                    <div class="col-lg-8">
                      <label class="form-control-label" for="lblTribeCode">Tribe Code</label>
                      <input type="text" class="form-control" id="txtTribeCode" name="txtTribeCode" placeholder="Tribe Code" autocomplete="off" data-toggle="validator" data-error="Please fill out this field" required />
                      <div class="help-block with-errors"></div>
                      <input type="hidden" name="isNewRecord" id="isNewRecord" val="0">
                      <input type="hidden" name="id_tribe" id="id_tribe">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group">
                  <div class="col-lg-12">
                    <div class="col-lg-8">
                      <label class="form-control-label" for="lblTribeDesc">Tribe Name</label>
                      <input type="text" class="form-control" id="txtTribeDesc" name="txtTribeDesc" placeholder="Tribe Name" autocomplete="off" data-toggle="validator" data-error="Please fill out this field" required/>
                      <div class="help-block with-errors"></div>
                    </div>
                  </div>
                </div>
...
<script>
  $(document).ready(function () {
    ...
    let url = baseURL + 'master/load_data_tribe';
    let ajaxData = {
      "url"  : url,
      "type" : "POST",
      "data"    : function ( d ) {
    ...
    { "data": "tribe_code", "width":"200px", "class":"text-left"},
    { "data": "tribe_desc", "width":"100px", "class":"text-left"},
    { 
      "data": "",
      "width":"80px",
      "class":"text-center",
   ...
   $('#table_data').on( 'click', 'a.action-edit', function () {
    ...
    $("#isNewRecord").val("0");
    $("#id_tribe").val(data.id_tribe);
    $("#txtTribeCode").val(data.tribe_code);
    $("#txtTribeDesc").val(data.tribe_desc);
    $("#modal-edit-label").html('Edit : ' +  data.tribe_desc + '( ' + data.tribe_code + ' )');
   ...
   $('#table_data ').on( 'click', 'a.action-delete', function () {
    ...
    data      = table.row( $(this).parents('tr') ).data();
    id_delete = data.id_tribe;


    $("#modal-delete-label").html('Delete Data : ' + data.tribe_desc + '( ' + data.tribe_code + ' )');
   ...
   $('#button-delete').on( 'click', function () {
    ...
    $.ajax({
      url       : baseURL + 'master/delete_Tribe/' + id_delete,
      type      : 'GET',
      beforeSend  : function(){
        customLoading('show');
      },
   ...
   $("#btnPrint").on("click", function(){
    var url   ="<?php echo site_url(); ?>Master/cetak_data_tribe";
