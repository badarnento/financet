<div class="row">   
  <div id="accordion" class="panel panel-info boxshadow animated slideInDown">
    <div class="panel-heading">
      <div class="row">
        <div class="col-xs-6">
          <a id="aTitleList" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse-data">List Division</a>
        </div>
        <div class="col-xs-6">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <div class="col-md-offset-5 col-md-2 m-b-20">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-lg-12">
                  <div class="col-lg-8">
                    <label class="form-control-label" for="lblDirectoratName">Directorate</label>
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-lg-12">
                  <div class="col-lg-8">
                    <label class="form-control-label" for="lblDivisionCode">Division Code</label>
                    <input type="text" class="form-control" id="txtDivisionCode" name="txtDivisionCode" placeholder="Division Code" autocomplete="off" data-toggle="validator" data-error="Please fill out this field" required />
                    <div class="help-block with-errors"></div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-lg-12">
                  <div class="col-lg-8">
                    <label class="form-control-label" for="lblDivisionName">Division Name</label>
                    <input type="text" class="form-control" id="txtDivisionName" name="txtDivisionName" placeholder="Division Name" autocomplete="off" data-toggle="validator" data-error="Please fill out this field" required/>
                    <div class="help-block with-errors"></div>
                  </div>
                </div>
              </div>
...
<script>
  $(document).ready(function () {
    ...
    let url = baseURL + 'master/load_data_division';
    let ajaxData = {
      "url"  : url,
      "type" : "POST",
      "data"    : function ( d ) {
    ...
    { "data": "division_code", "width":"200px", "class":"text-left"},
   ...
   $('#form-edit').validator().on('submit', function(e) {
    if (e.isDefaultPrevented()) {
     ...
     $.ajax({
      url     : baseURL + 'master/save_division',
      type    : "POST",
   ...
   $('#table_data').on( 'click', 'a.action-edit', function () {
    ...
    $("#isNewRecord").val("0");
    $("#id_division").val(data.id_division);
    $("#ddlDirectoratName").val(data.id_dir_code);
    $("#txtDivisionCode").val(data.division_code);
    $("#txtDivisionName").val(data.division_name);
    $("#modal-edit-label").html('Edit : ' +  data.division_name + '( ' + data.division_code + ' )');
   ...
   $('#table_data ').on( 'click', 'a.action-delete', function () {
    ...
    data      = table.row( $(this).parents('tr') ).data();
    id_delete = data.id_division;


    $("#modal-delete-label").html('Delete Data : ' + data.division_name + '( ' + data.division_code + ' )');
   ...
   $('#button-delete').on( 'click', function () {
    ...
    $.ajax({
      url       : baseURL + 'master/delete_division/' + id_delete,
      type      : 'GET',
      beforeSend  : function(){
        customLoading('show');
      },
  ...
  $("#btnPrint").on("click", function(){
    var url   ="<?php echo site_url(); ?>Master/cetak_data_division";
