<div class="row">
        ...
        <table id="table_data" class="table table-responsive w-full table-striped table-hover table-bordered display cell-border stripe hover dataTable small">
          ...
          <thead>
            ...
            <tr>
              ...
              <th class="text-center">Remark Approved HOU</th> 
              <th class="text-center">Approved HOG</th>        
              <th class="text-center">Remark Approved HOG</th>
        ...
        <table id="table_data2" class="table table-responsive w-full table-striped table-hover table-bordered display cell-border stripe hover dataTable small">
          ...
          <thead>
            ...
            <tr>
              ...
              <th class="text-center">Approved HOG</th>        
              <th class="text-center">Remark Approved HOG</th>
              <th class="text-center">FPJP Close</th>
 ...
 <script>
   ...
   $(document).ready(function(){
    ...
    let url  = baseURL + 'userapprovedjournalhog/load_data_inquiry';
    ...
    Pace.track(function(){
      $('#table_data').DataTable({
        ...
        { "data": "remark_approved_hou", "width": "300px", "class": "text-center" },
        { "data": "status", "width": "150px", "class": "text-center" },
        { "data": "remark_approved_hog", "width": "300px", "class": "text-center" }
        ],
        "pageLength"      : 100,
        "ordering"        : false,
        "scrollY"         : 480,
    ...
    let url2  = baseURL + 'userapprovedjournalhog/load_data_journal_after_tax';
    ...
    $("#btnPrint").on("click", function(){
     ...
     let url   ="<?php echo site_url(); ?>userapprovedjournalhog/download_data_after_tax";
...

    {
      ...
      $.ajax({
        ...
        url   : baseURL + 'userapprovedjournalhog/load_ddl_all_vendor_1m',
...

    {
      ...
      $.ajax({
        ...
        url   : baseURL + 'userapprovedjournalhog/load_ddl_filter_date_by',
...

    {
      ...
      $.ajax({
        ...
        url   : baseURL + 'userapprovedjournalhog/load_ddl_approved',
...

  {
    ...
    $.ajax({
      ...
      url   : baseURL + 'userapprovedjournalhog/load_ddl_Approve_batch',
      type  : "POST",
...
$("#btn_save").on('click', function () {
  ...
  detail_data_all.push(detail_data);
    ...
    if(data_line.length > 0)
    {
      ...
      $.ajax({
        url   : baseURL + 'userapprovedjournalhog/update_user_approved_journal',
        type  : "POST",
        data  : data,
         beforeSend  : function()
          {
