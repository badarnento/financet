<div class="row">
        ...
        <table id="table_data" class="table table-responsive w-full table-striped table-hover table-bordered display cell-border stripe hover dataTable small">
          ...
          <thead>
            ...
            <tr>
              ...
              <th class="text-center">Approved HOU</th>        
 ...
 <script>
   ...
   $(document).ready(function(){
    ...
    let url  = baseURL + 'userapprovedjournalhou/load_data_inquiry';
    ...
    let url2  = baseURL + 'userapprovedjournalhou/load_data_journal_after_tax';
    ...
    $("#btnPrint").on("click", function(){
     ...
     let url   ="<?php echo site_url(); ?>userapprovedjournalhou/download_data_after_tax";
...

    {
      ...
      $.ajax({
        ...
        url   : baseURL + 'userapprovedjournalhou/load_ddl_all_vendor_1m',
...

    {
      ...
      $.ajax({
        ...
        url   : baseURL + 'userapprovedjournalhou/load_ddl_filter_date_by',
...

    {
      ...
      $.ajax({
        ...
        url   : baseURL + 'userapprovedjournalhou/load_ddl_approved',
...

  {
    ...
    $.ajax({
      ...
      url   : baseURL + 'userapprovedjournalhou/load_ddl_Approve_batch',
      type  : "POST",
...
$("#btn_save").on('click', function () {
  ...
  detail_data_all.push(detail_data);
    ...
    if(data_line.length > 0)
    {
      ...
      $.ajax({
        url   : baseURL + 'userapprovedjournalhou/update_user_approved_journal',
        type  : "POST",
        data  : data,
         beforeSend  : function()
          {
