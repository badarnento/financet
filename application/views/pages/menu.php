            ...
            $.ajax({
                ...
                success:function(result) {
                    ...
                    if(result.status == true){
                        customNotif('Sukses','Data Berhasil di Simpan!','success' );
                        show1   = "";
                        idItem1 = "";
                        show2   = "";
                        idItem2 = "";
                        ...
                        customNotif('Error', result.ket ,'error' );
                        show1   = "";
                        idItem1 = "";
                        show2   = "";
                        idItem2 = "";
        ...
        $.ajax({
            ...
            success : function(result){
                ...
                if (result==1) {
                    ...
                    customNotif('Error', result ,'error' );
                }
            }
        }); 
        return false;
    ...
    $("#btnUpdate").click(function(){
        ...
        $.ajax({
            ...
            success : function(result){
                if (result==1) {
                    table.ajax.reload(null, false);
                    customNotif('Sukses','Data Berhasil di Update!','success' );
