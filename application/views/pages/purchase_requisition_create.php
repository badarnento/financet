		...
		<div class="col-sm-6">
			<div class="form-group m-b-10">
	            ...
	            <div class="col-sm-9 col-md-6">
	              <input type="text" class="form-control" id="pr_name" placeholder="PR Name" autocomplete="off">
	            </div>
	        </div>
	        <div class="form-group m-b-10">
	    	...
	    	<div class="form-group m-b-10">
	            ...
	            <div class="col-sm-9 col-md-6">
					<div class="input-group">
						<input type="text" class="form-control mydatepicker" id="pr_date" placeholder="dd/mm/yyyy" value="<?= date("d-m-Y")?>">
...
<div class="row">
	<div class="white-box">
		<div class="row">
			<div class="col-md-12">
				<h4 id="table_line_title">PR Lines</h4>
			</div>
			<div class="col-md-12">
...
<script>
  $(document).ready(function(){
	...
	$('#table_data tbody').on('change', 'tr td select.rkap_opt', function () {
		...
		getNature(1, id_rkap, id_select=0);
  		$("#nominal-"+id_row).val('0');
    });
		...
		else if (fatalNominal == true)
		{
			...
			table.rows().eq(0).each( function ( index ) {
				...
				if(rkap_val != "" && line_name_val != "" && parseInt(fund_av.replace(/\./g, '')) > 0 && parseInt(nominal_val.replace(/\./g, '')) > 0){
		    		data_lines.push({'id_rkap' : rkap_val, 'id_fs' : fs_val, 'nominal' : parseInt(nominal_val.replace(/\./g, '')), 'line_name' : line_name_val, 'detail_data' : data_detail});
				}
			});
    ...
    function get_all_data(){
    	...
    	/*$.each( form_data, function( key, value ) {
			let parse_rkap = $($.parseHTML(value.rkap_name));
			let parse_nominal = $($.parseHTML(value.nominal));
			console.log(parse_rkap.find('input'));
			console.log(parse_nominal.find('input'));
	    });*/
	    ...
	    table.rows().every( function ( rowIdx, tableLoop, rowLoop ) {
			...
			// let parse_rkap = $($.parseHTML(data.rkap_name));
			// let parse_nominal = $($.parseHTML(data.nominal));
			// console.log(parse_rkap.find('select').find(':selected'));
			// console.log(parse_nominal.find('input').find(':selected'))
		} );
