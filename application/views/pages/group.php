<div class="row">   
  <div id="accordion" class="panel panel-info boxshadow animated slideInDown">
    <div class="panel-heading">
      <div class="row">
        <div class="col-md-6">
          <a id="aTitleList" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse-data">USER GROUP LIST</a>
        </div>
        <div class="col-md-6">
        ...
        <div class="modal-body"> 
          ...
          <div class="row">
            <div class="form-group">
              <div class="col-lg-12">
                <div class="col-lg-8">
                  <label class="form-control-label" for="lblGroup">Group Report</label>
                  <textarea name="txtGroup" id="txtGroup" class="form-control" rows="3" autocomplete="off" data-toggle="validator" data-error="Please fill out this field" placeholder="Group Report" required ></textarea>
...
<script>
  $(document).ready(function () {
    ...
    let url = baseURL + 'master/load_data_group';
    let ajaxData = {
      "url"  : url,
      "type" : "POST",
      "data"    : function ( d ) {
   ...
   $('#table_data').on( 'click', 'a.action-edit', function () {
    ...
    $("#txtGroup").val(data.group_report);
    $("#modal-edit-label").html('Edit : ' +  data.group_report );
   ...
   $('#table_data ').on( 'click', 'a.action-delete', function () {
    ...
    data      = table.row( $(this).parents('tr') ).data();
    id_delete = data.id_group;


    $("#modal-delete-label").html('Delete Data : ' + data.group_report );
   ...
   $('#button-delete').on( 'click', function () {
    ...
    $.ajax({
      url       : baseURL + 'master/delete_group/' + id_delete,
      type      : 'GET',
      beforeSend  : function(){
        customLoading('show');
      },
  ...
  $("#btnPrint").on("click", function(){
    var url   ="<?php echo site_url(); ?>Master/cetak_data_group";
