    ...
    <div class="row">
      ...
      <div class="col-sm-6">
          <div class="form-group m-b-10">
            <label class="col-sm-3 control-label text-left">FPJP Type <span class="pull-right">:</span></label>
            <div class="col-sm-7 col-md-8">
              <label id="fpjp_type" class="control-label text-left"><?= get_type($fpjp_type) ?></label>
            </div>
          </div>
          <div class="form-group m-b-10">
            <label class="col-sm-3 control-label text-left">FPJP Number <span class="pull-right">:</span></label>
            <div class="col-sm-7 col-md-8">
              <label id="fpjp_number" class="control-label text-left"><?= $fpjp_number ?></label>
            </div>
          </div>
          <div class="form-group m-b-10">
            <label class="col-sm-3 control-label text-left">FPJP Name <span class="pull-right">:</span></label>
            <div class="col-sm-7 col-md-8">
        <?php if($coa_edit):?>
                <label id="fpjp_namexx" class="control-label text-left"><?= $fpjp_name ?></label>
              <input type="hidden" class="form-control" id="fpjp_name" readonly value="<?= $fpjp_name ?>">
        <?php else: ?>
        <input type="text" class="form-control input-sm" id="fpjp_name" placeholder="FPJP Name" autocomplete="off" value="<?= $fpjp_name ?>">
        <?php endif; ?>
            </div>
          </div>
          <div class="form-group m-b-10">
              <label class="col-sm-3 control-label text-left">Currency<?= ($fpjp_currency != "IDR") ? "/Rate" : "" ?> <span class="pull-right">:</span></label>
              <div class="col-sm-7 col-md-8">
                <label id="fpjp_currency" class="control-label"><?= strtoupper($fpjp_currency) ?><?= (strtoupper($fpjp_currency) != "IDR") ? " / ".$fpjp_rate : "" ?></label>
              </div>
          </div>
          <div class="form-group m-b-10">
            <label class="col-sm-3 control-label text-left">Total Amount <span class="pull-right">:</span></label>
            <div class="col-sm-7 col-md-8">
        <?php if($coa_edit):?>
                <label id="amountxx" class="control-label text-left"><?= $fpjp_amount ?></label>
              <input type="hidden" class="form-control" id="amount" readonly value="<?= $fpjp_amount ?>">
        <?php else: ?>
        ...
        <?php endif; ?>
          ...
          <div class="form-group m-b-10">
            <label class="col-sm-3 control-label text-left">Directorate <span class="pull-right">:</span></label>
            <div class="col-sm-7 col-md-8">
              <label class="control-label"><?= get_directorat($fpjp_directorat) ?></label>
            </div>
          </div>
          <div class="form-group m-b-10">
            <label class="col-sm-3 control-label text-left">Division <span class="pull-right">:</span></label>
            <div class="col-sm-7 col-md-8">
              <label class="control-label text-left"><?= get_division($fpjp_division) ?></label>
            </div>
          </div>
          <div class="form-group m-b-10">
            <label class="col-sm-3 control-label text-left">Unit <span class="pull-right">:</span></label>
            <div class="col-sm-7 col-md-8">
              <label class="control-label text-left"><?= get_unit($fpjp_unit) ?></label>
            </div>
          </div>
          <div class="form-group m-b-10">
            <label class="col-sm-3 control-label text-left">Justification <span class="pull-right">:</span></label>
            <div class="col-sm-7 col-md-8">
            <?php if($id_fs > 0): ?>
        ...
        <div class="col-sm-6">
          <div class="form-group m-b-10">
            ...
            <div class="col-sm-9 col-md-6">
              ...
              <?php if($coa_edit):?>
                      <label id="fpjp_datexx" class="control-label text-left"><?= $fpjp_date ?></label>
              <input type="hidden" class="form-control mydatepicker" id="fpjp_date" value="<?= $fpjp_date ?>">
              <?php else: ?>
              <input type="text" class="form-control mydatepicker input-sm" id="fpjp_date" placeholder="dd-mm-yyyy" value="<?= $fpjp_date ?>">
              ...
              <select class="form-control input-sm" id="vendor_name" name="vendor_name">
                  ...
                  <?php
                      ...
                      foreach($get_vendor as $key => $value):
                        $selectedVendor = ($key == $selected_vendor) ? ' selected' : '';
                  ?>
                      <option value="<?= $key ?>" data-vendor="<?= $value ?>"<?= $selectedVendor ?>><?= $value ?></option>
                  <?php
                      endforeach; 
                  ?>
              </select>
          ...
          <div class="form-group m-b-10">
              ...
              <div class="col-sm-9 col-md-6">
                <input type="text" class="form-control input-sm" id="account_name" placeholder="Nama Pemilik Rekening" readonly="true" required value="<?= $selected_acc_name ?>">
              </div>
          </div>
          <div class="form-group m-b-10">
              <label for="account_number" class="col-sm-3 control-label text-left">Account Number<span class="pull-right">:</span></label>
              <div class="col-sm-9 col-md-6">
                <input type="text" class="form-control input-sm" id="account_number" placeholder="Nomor Rekening" readonly="true" required value="<?= $selected_acc_number ?>">
              </div>
          </div>

        <div class="form-group m-b-10">
          <label class="col-sm-3 control-label text-left">Status <span class="pull-right">:</span></label>
              <div class="col-sm-7 col-md-8">
                <label class="control-label text-left">
                  <?php 
                    if(strtolower($fpjp_status) == "approved"){
                $badge = "badge-success";
              }else if(strtolower($fpjp_status) == "returned"){
                $badge = "badge-warning";
              }else if(strtolower($fpjp_status) == "rejected"){
                $badge = "badge-danger";
              }
              else{
                $badge = "badge-default";
            ...
            ?>
                  <div class="badge <?= $badge ?> text-lowercase font-size-12"> <?= ucwords($fpjp_status) ?> </div>
              </label>
              </div>
          </div>
          <div class="form-group m-b-10">
            <label class="col-sm-3 control-label text-left">Submitter/Jabatan <span class="pull-right">:</span></label>
              <div class="col-sm-7 col-md-8">
                <label class="control-label text-left"><?= $fpjp_submitter ?>/<?= $fpjp_jabatan_sub ?></label>
              </div>
          </div>
          <div class="form-group m-b-10">
            <label class="col-sm-3 control-label text-left">Last Update <span class="pull-right">:</span></label>
              <div class="col-sm-7 col-md-8">
...
<script>
  ...
  const opt_tax  = '<option value="0">0</option><option value="1"> 1% </option><option value="1.1"> 1,1% </option><option value="10"> 10% </option><option value="11"> 11% </option>';
...
/*
  ...
  let rkap_desc      = '<div class="form-group m-b-0"><input id="rkap_desc-'+counter+'" maxlength="150" class="form-control input-sm rkap_desc"'+ disabled_el +'></div>';
  ...
  let price          = '<div class="form-group m-b-0"><input id="price-'+counter+'" data-id="'+counter+'" class="form-control input-sm price text-right money-format-negative" value="0"'+ disabled_el+disabled_el2 +'></div>';
  ...
  $('#table_data tbody').on( 'click', 'tr', function () {
      ...
      data_detail.forEach(function(value, i) {
        ...
        let rkap_desc_val  = '<div class="form-group m-b-0"><input id="rkap_desc-'+ j +'" maxlength="150" class="form-control input-sm rkap_desc" value="'+value.rkap_desc+'"'+ disabled_el +'></div>';
        ...
        let tax_opt     = '<div class="form-group m-b-0"><select id="tax_opt-'+ j +'"'+ disabled_el+disabled_el2 +' class="form-control input-sm tax_opt select-center">';
            tax_opt += opt_tax;
            tax_opt += '</select></div>';
        let price          = '<div class="form-group m-b-0"><input id="price-'+j+'" data-id="'+j+'" class="form-control input-sm price text-right money-format-negative" value="'+formatNumber(value.price)+'"'+ disabled_el+disabled_el2  +'></div>';
  ...
  $('#addRow-detail').on( 'click', function () {
    ...
    if($("#rkap_desc-"+indexNow_detail).val() == "" || $("#nature_opt-"+indexNow_detail).val() == 0 || $("#nominal_detail-"+indexNow_detail).val() == 0){
      ...
      let rkap_desc      = '<div class="form-group m-b-0"><input id="rkap_desc-'+numDetail+'" maxlength="150" class="form-control input-sm rkap_desc"'+ disabled_el +'></div>';
      ...
      let tax_opt     = '<div class="form-group m-b-0"><select id="tax_opt-'+numDetail+'" class="form-control input-sm tax_opt select-center">';
          tax_opt += opt_tax;
          tax_opt += '</select></div>';
      let price          = '<div class="form-group m-b-0"><input id="price-'+numDetail+'" data-id="'+numDetail+'" class="form-control input-sm price text-right money-format-negative" value="0"'+ disabled_el +'></div>';
