...
<script>
  $(document).ready(function(){
    ...
    let url        = baseURL + 'fpjp/approval/api/load_fpjp_to_approve';
    let ajaxData = {
      "url"  : url,
      "type" : "POST",
      "dataType": "json",
   ...
   let jsonData = [
	...
	$('#table_data').on('click', 'a.action-view', function () {
		id_fpjp_approval = $(this).data('id');
	  	$(location).attr('href', baseURL + 'fpjp/approval/' + id_fpjp_approval);
	});
