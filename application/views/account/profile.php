        ...
        <div class="white-box p-l-20 p-r-20">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php } ?>
                        <?php echo form_open_multipart("account/edit", array("class" => "form-horizontal"));?>
                        <div class="form-group">
                            <label class="col-md-12" for="example-email">Username</label>
                            <div class="col-md-12">
                                <input type="email" name="username" class="form-control" value="<?php echo $user->USERNAME ?>" disabled="disabled"> </div>
                        </div>
                        <div class="form-group">
