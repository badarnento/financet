...
<div class="row">
  <div class="white-box boxshadow">
      ...
      <?php } else if($trx_status == "rejected"){ ?>
          <h3 class="text-danger">This PR has been <b>Rejected!</b></h2>
          <h5>Rejected at <?= $trx_date ?></h5>
      <?php } else if($trx_status == "returned"){ ?>
          <h3 class="text-warning">This PR has been <b>Returned!</b></h3>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group m-b-10">
                  <label for="approval_remark" class="control-label">Remark to User <span class="pull-right">:</span></label>
...
<script>
  ...
  $('.btn-approval').on( 'click', function () {
    ...
    if(approve == "reject"){
      ...
      approvaL_display = '<h3 class="text-danger">This PR has been <b>Rejected!</b></h2>';
    }
      ...
      approvaL_display = '<h3 class="text-warning">This PR has been <b>Returned!</b></h3>';
    }
    else{
  ...
  $('#btn_approval').on( 'click', function () {
    ...
    if (fatalError == true)
    {
      ...
      $.ajax({
        url       : baseURL + 'pr/approval/api/action_approval',
        type      : 'post',
        data      : { id_pr : ID_PR, level : LEVEL, proc_support : proc_support, hou_procurement : hou_procurement, /*doc_list : doc_list,*/ approval : approve, remark : remark, pr_category : pr_category, po_buyer : po_buyer},
        beforeSend  : function(){
                        customLoading('show');
                      },
        dataType : 'json',
