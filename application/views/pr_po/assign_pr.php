      ...
      <div class="col-sm-3">
        <div class="form-group">
          ...
          <select class="form-control" id="status">
            ...
            <option value="need_assign" selected>Need Assign</option>
...
<script>
  $(document).ready(function(){
    ...
    let url        = baseURL + 'pr/approval/api/load_pr_to_assign';
    let ajaxData = {
      "url"  : url,
      "type" : "POST",
      "dataType": "json",
   ...
   let jsonData = [
			...
			{ "data": "pr_number", "width": "100px", "class": "p-5" },
			{ "data": "pr_name", "width": "100px", "class": "p-5" },
			{ "data": "total_amount", "width": "100px", "class": "text-right p-5" },
			{ "data": "status_description", "width": "100px", "class": "text-center p-5" },
      { "data": "status_assign", "width": "100px", "class": "text-center p-5" },
			{ 
                "data": "id_pr",
                "width":"50px",
                "class":"text-center",
	...
	$('#table_data').on('click', 'a.action-view', function () {
		id_pr = $(this).data('id');
	  	$(location).attr('href', baseURL + 'pr/assign/' + id_pr);
	});
