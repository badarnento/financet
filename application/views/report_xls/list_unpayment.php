...
<script>
  ...
  $("#btnPrint").on("click", function(){
    ...
    window.open(url+'?from='+date_from +"&to="+ date_to +"&status="+ status+"&filterdateby="+ filterdateby, '_blank');
  ...
  {
    $.ajax({
      url   : baseURL + 'report/list-payment/api/load_ddl_filter_date_unpayment_by',
      type  : "POST",
      dataType: "html",
