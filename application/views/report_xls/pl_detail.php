  ...
  <div class="row">
    <div class="form-group">
      <div class="col-md-2 col-md-2 col-sm-12">
        <button id="btnCetak" class="btn btn-success btn-rounded btn-block" type="button" ><i class="fa  fa-file-excel-o"></i> <span>Cetak PL DETAIL</span></button>
      </div>
    </div>
  </div>
  </div>
...
<script>
  $(document).ready(function(){
    ...
    $("#btnCetak").on("click", function(){
      ...
      url   ="<?php echo site_url(); ?>report_xls/PlDetail/load_pldetail";
