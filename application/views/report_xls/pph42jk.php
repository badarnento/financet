  ...
  <div class="row">
    <div class="form-group">
      <div class="col-md-3 col-md-3 col-sm-12">
        <button id="btnCetak" class="btn btn-success btn-rounded btn-block" type="button" ><i class="fa  fa-file-excel-o"></i> <span>Download Pph 4(2)</span></button>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="white-box boxshadow m-b-0 border-top-only-5 panel-title-custom">
    <div class="col-md-6">
      <h5 class="font-weight-700 m-0 text-uppercase">Pph 4(2) Jasa Kontruksi</h5>
    </div>
  </div>
        ...
        <table id="table_data" class="table dataTable table-responsive table-striped table-bordered cell-border stripe small hover w-full">
            <thead>
              <tr>
                ...
                <th class="text-center">Pelaksana Jaskon Kecil Bruto</th>
                <th class="text-center">PPh</th>
                <th class="text-center">Pelaksana Jaskon Non Kualifikasi Bruto</th>
                <th class="text-center">PPh</th>
                <th class="text-center">Pelaksana Jaskon Lainnya Bruto</th>
                <th class="text-center">PPh</th>
                <th class="text-center">Perencana /Pengawas Jaskon Bruto</th>
                <th class="text-center">PPh</th>
                <th class="text-center">Perencanaan /Pengawasan</th>
                <th class="text-center">Perencana /Pengawas Jaskon Non Kualifikasi Bruto</th>
                <th class="text-center">PPh</th>
                <th class="text-center">Perencanaan /Pengawasan</th>
...
<script>
  ...
  let url = baseURL + 'report_xls/pph/load_pph42jk';
  ...
  Pace.track(function(){
    $('#table_data').DataTable({
      ...
      "columns"         : [
                  ...
                  { "data": "pph_jkb", "width":"100px", "class":"text-right"},
                  { "data": "dpp", "width":"100px", "class":"text-right"},
                  { "data": "dpp_null", "width":"100px", "class":"text-right"},
                  { "data": "pph_jnkb", "width":"100px", "class":"text-right"},
                  { "data": "dpp_null", "width":"100px", "class":"text-right"},
                  { "data": "pph_jlb", "width":"100px", "class":"text-right"},
                  { "data": "dpp_null", "width":"100px", "class":"text-right"},
                  { "data": "pph_pjb", "width":"100px", "class":"text-right"},
                  { "data": "pcn_pgn", "width":"100px", "class":"text-right"},
                  { "data": "dpp_null", "width":"100px", "class":"text-right"},
                  { "data": "pph_pjnkb", "width":"100px", "class":"text-right"},
                  { "data": "pcn_pgn", "width":"100px", "class":"text-right"},
  ...
  $('#btnView').on( 'click', function () {
    ...
    $("#btnCetak").on("click", function(){
      year  = $('#year').val();
      month  = $('#month').val();
      url         ="<?php echo site_url(); ?>report_xls/Pph/cetak_pph42jk";
