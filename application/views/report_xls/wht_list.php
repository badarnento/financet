  ...
  <div class="row">
    <div class="form-group">
      <div class="col-md-2 col-md-2 col-sm-12">
        <button id="btnCetak" class="btn btn-success btn-rounded btn-block" type="button" ><i class="fa  fa-file-excel-o"></i> <span>Cetak WHT List</span></button>
      </div>
    </div>
  </div>
  </div>
...
<div class="row">
  <div class="white-box boxshadow m-b-0 border-top-only-5 panel-title-custom">
    <div class="col-md-6">
      <h5 class="font-weight-700 m-0 text-uppercase">WHT List</h5>
    </div>
  </div>
        ...
        <table id="table_data" class="table dataTable table-responsive table-striped table-bordered cell-border stripe small hover w-full">
            <thead>
              <tr>
                ...
                <th class="text-center">Reclass</th>
...
<script>
  ...
  let url = baseURL + 'report_xls/Wht_list/load_data';
  ...
  Pace.track(function(){
    $('#table_data').DataTable({
      ...
      "columns"         : [
                  ...
                  { "data": "expense_type", "width":"200px", "class":"text-left"},
                  { "data": "nature", "width":"80px", "class":"text-left"},
                  { "data": "account_desc", "width":"300px", "class":"text-left"},
                  { "data": "outstanding", "width":"100", "class":"text-right"},
                  { "data": "reclass", "width":"100", "class":"text-right"},
                  { "data": "reverse", "width":"100", "class":"text-right"},
      ...
      $( api.column( 4 ).footer() ).html(formatNumber(outstanding));
      $( api.column( 5 ).footer() ).html(formatNumber(reclass));
      $( api.column( 6 ).footer() ).html(formatNumber(reverse));
      $( api.column( 7 ).footer() ).html(formatNumber(tgl_1));
      $( api.column( 8 ).footer() ).html(formatNumber(tgl_2));
      $( api.column( 9 ).footer() ).html(formatNumber(tgl_3));
      $( api.column( 10 ).footer() ).html(formatNumber(tgl_4));
      $( api.column( 11 ).footer() ).html(formatNumber(tgl_5));
      $( api.column( 12 ).footer() ).html(formatNumber(tgl_6));
      $( api.column( 13 ).footer() ).html(formatNumber(tgl_7));
      $( api.column( 14 ).footer() ).html(formatNumber(tgl_8));
      $( api.column( 15 ).footer() ).html(formatNumber(tgl_9));
      $( api.column( 16 ).footer() ).html(formatNumber(tgl_10));
      $( api.column( 17 ).footer() ).html(formatNumber(tgl_11));
      $( api.column( 18 ).footer() ).html(formatNumber(tgl_12));
      $( api.column( 19 ).footer() ).html(formatNumber(tgl_13));
      $( api.column( 20 ).footer() ).html(formatNumber(tgl_14));
      $( api.column( 21 ).footer() ).html(formatNumber(tgl_15));
      $( api.column( 22 ).footer() ).html(formatNumber(tgl_16));
      $( api.column( 23 ).footer() ).html(formatNumber(tgl_17));
      $( api.column( 24 ).footer() ).html(formatNumber(tgl_18));
      $( api.column( 25 ).footer() ).html(formatNumber(tgl_19));
      $( api.column( 26 ).footer() ).html(formatNumber(tgl_20));
      $( api.column( 27 ).footer() ).html(formatNumber(tgl_21));
      $( api.column( 28 ).footer() ).html(formatNumber(tgl_22));
      $( api.column( 29 ).footer() ).html(formatNumber(tgl_23));
      $( api.column( 30 ).footer() ).html(formatNumber(tgl_24));
      $( api.column( 31 ).footer() ).html(formatNumber(tgl_25));
      $( api.column( 32 ).footer() ).html(formatNumber(tgl_26));
      $( api.column( 33 ).footer() ).html(formatNumber(tgl_27));
      $( api.column( 34 ).footer() ).html(formatNumber(tgl_28));
      $( api.column( 35 ).footer() ).html(formatNumber(tgl_29));
      $( api.column( 36 ).footer() ).html(formatNumber(tgl_30));
      $( api.column( 37 ).footer() ).html(formatNumber(tgl_31));
      $( api.column( 38 ).footer() ).html(formatNumber(total));
        },
      "pageLength"      : 100,
      "ordering"        : false,
      "scrollY"         : 480,
  ...
  $('#btnView').on( 'click', function () {
    ...
    $("#btnCetak").on("click", function(){
      year   = $("#year").val();
      month  = $("#month").val();
      url   ="<?php echo site_url(); ?>report_xls/Wht_list/cetak_wht_list";
