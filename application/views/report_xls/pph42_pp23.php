...
<div class="white-box boxshadow">
 ...
 <div class="col-md-2">
      <div class="form-group">
        <button id="btnView" class="btn btn-default btn-rounded custom-input-width w-200p btn-block" type="button"><i class="fa fa-search"></i> <span>VIEW</span></button>
      </div>
  </div>
  <div class="row">
    <div class="form-group">
      <div class="col-md-3 col-md-3 col-sm-12 w-auto">
        <button id="btnCetak" class="btn btn-success btn-rounded btn-block" type="button" ><i class="fa  fa-file-excel-o"></i> <span>Download PP23</span></button>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="white-box boxshadow m-b-0 border-top-only-5 panel-title-custom">
    <div class="col-md-6">
      <h5 class="font-weight-700 m-0 text-uppercase">Pph 4(2) PP23</h5>
    </div>
  </div>
        ...
        <table id="table_data" class="table dataTable table-responsive table-striped table-bordered cell-border stripe small hover w-full">
            <thead>
              <tr>
                ...
                <th class="text-center">Tanggal NTPN</th>
...
<script>
  ...
  let url = baseURL + 'report_xls/pph/load_pph42_pp23';
  ...
  Pace.track(function(){
    $('#table_data').DataTable({
      ...
      "columns"         : [
                  ...
                  { "data": "npwp_dipotong", "width":"100px", "class":"text-left"},
                  { "data": "wp_dipotong", "width":"300", "class":"text-left"},
                  { "data": "alamat", "width":"500px", "class":"text-left"},
                  { "data": "ntpn", "width":"200px", "class":"text-left"},
                  { "data": "tgl_ntpn", "width":"100px", "class":"text-left"},
                  { "data": "dpp", "width":"100px", "class":"text-right"},
                  { "data": "pph", "width":"100px", "class":"text-right"},
                  { "data": "sket_pp23", "width":"100px", "class":"text-center"},
                  { "data": "npwp_pemotong", "width":"100px", "class":"text-left"},
  ...
  $('#btnView').on( 'click', function () {
    ...
    $("#btnCetak").on("click", function(){
      year  = $('#year').val();
      month  = $('#month').val();
      url         ="<?php echo site_url(); ?>report_xls/Pph/cetak_pph42_pp23";
